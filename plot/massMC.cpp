...
void massMC(TString mode = "zero_jet", int button = 0)
{
  ...
  //  if (max == mc_h->GetBinContent(mc_h->GetMaximumBin()))
   //     max = max * factor;
    ...
    hs->GetXaxis()->SetTitle("M_{#mu#mu} [GeV]");
